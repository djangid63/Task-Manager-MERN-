    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8 animate-fadeIn">
        <div className="text-center transform hover:scale-105 transition duration-300">
          ...
          <h2 className="mt-6 text-3xl font-extrabold text-gray-900 animate-slideFromTop">Sign in</h2>
        ...
        <form className="mt-8 space-y-6 bg-white p-8 rounded-lg shadow-2xl animate-slideFromBottom transition-all duration-300 hover:shadow-blue-200" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between animate-fadeIn">
            <div className="flex items-center">
              <input
                ...
                name="remember_me"
                type="checkbox"
                className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded transition duration-300 ease-in-out transform hover:scale-110"
              />
            ...
            <div className="text-sm">
              <a href="#" className="font-medium text-blue-600 hover:text-blue-500 transition-colors duration-300 hover:underline">
          ...
          <div className="flex items-center justify-between mt-8">
            <div className="text-sm">
              <Link to="/signup" className="font-medium text-blue-600 hover:text-blue-500 transition-colors duration-300 hover:underline">
                Create account
              </Link>
            </div>
            <button
